...
public interface UsersMapper {
	...
	//登录
	public Users login(@Param(value="email") String email, @Param(value="password") String password) throws Exception;
...
/*	//查询我发布的任务
	...
	public int SearchAssignment(@Param(value="receiver_id")int receiver_id)  throws Exception;
	//查询任务接受者的信誉积分
	public int SearchCredit(int receiver_id) throws Exception;
	//放弃任务后任务接受者信誉降低
	public void ReduceCredit(@Param(value="receiver_id")int receiver_id,@Param(value="credit")int credit) throws Exception;
	//根据用户id查询用户详细信息
	...
	//分页查询我发布的任务
	public List<Assignment> MyAssignmentByPage(@Param(value="startPos")int startPos,@Param(value="pageSize")int pageSize,@Param(value="user_id")int user_id) throws Exception;
