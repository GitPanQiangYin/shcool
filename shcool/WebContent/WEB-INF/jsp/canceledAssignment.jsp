...
$(function(){
	...
	debugger;
		$(".tr").each(function(){
			$(this).find(".clickbutton2").click(function(){
				var assignment_id = $(this).attr("id");
				 $.ajax({
					url:"<%=basePath%>assignment/FindAssignmentById.action",
					data:{"assignment_id":assignment_id},
					type:"get",
					success:function(data){
						$("#assignment_name1").val(data.assignment_name);
						$("#brokerage1").val(data.brokerage);
						$("#starttime1").val(data.starttime);
						$("#endtime1").val(data.endtime);
						$("#detail1").val(data.detail);
						$("#assignment_id1").val(data.assignment_id);
						$("#brokerage").val(data.brokerage);
						},
				}); 
...
function republish(){
	$.post("<%=basePath%>assignment/republishAssignment.action",$("#changeassignment").serialize(),function(data){
		alert("重新发布成功！");
		window.location.reload();
	});
};
            ...
            <c:otherwise>  
                ...
                <table class="listtable">
                    ...
                    <tr class="tr">
                        ...
                        <td>${list.status }</td>
                         <td>
                            <a id="${list.assignment_id }" class="clickbutton2" href="javascript:void(0)">重新发布</a>
                         </td>
                    </tr>
                    </c:forEach>
                </table>
                    ...
                    <div id="myModal" class="modal">
									<div class="modal-content">
									  ...
									  <div class="modal-footer" align="center">
									   ...
									   <a  href="javascript:void(0)" style="color: white" onclick="cancel()">下架任务</a>
									  </div>
									  </div>
									</div>
									...
									<div class="modal-content">
									  ...
									  <div class="modal-footer" align="center">
									   <a  href="javascript:void(0)" style="color: white" onclick="republish()">重新发布&nbsp;&nbsp;&nbsp;</a>
