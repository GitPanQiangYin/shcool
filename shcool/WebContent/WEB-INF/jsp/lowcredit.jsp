...
function send(){
	...
	$(".tr").each(function(){
		var receiver_id=$(this).find(".clickbutton1").attr("id")
			var message_detail = $("#detail").val();
			$.ajax({
				url:"<%=basePath%>admin/sendWarningMessage.action",
				data:{"receiver_id":receiver_id,"message_detail":message_detail},
				type:"get",
            ...
            <c:otherwise>  
                ...
                <table class="listtable">
                    ...
                    <tr class="tr">
                        ...
                        <td>${list.status }</td>
                        <td>
                            <a id="${list.user_id }" class="clickbutton1" href="javascript:void(0)">发送警告信息</a>
                         </td>
                    </tr>
                    </c:forEach>
                </table> 
        ...
        <div id="myModal" class="modal">
									<div class="modal-content">
									  ...
									  <div class="modal-body">
										...
										<tr>
											<td height=30px; width=200px; align="right">消息内容:&nbsp;&nbsp;</td>
									  ...
									  <div class="modal-footer" align="center">
									   <a  href="javascript:void(0)" style="color: white" onclick="send()">发送&nbsp;&nbsp;&nbsp;&nbsp;</a>
