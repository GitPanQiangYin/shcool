				...
				var assignment_id = $(this).attr("id");
				 $.ajax({
					...
					success:function(data){
						...
						$("#href").attr("href","<%=basePath %>admin/queryAssignment.action?assignment_id="+assignment_id);
						},
				}); 
                    ...
                    <div id="myModal" class="modal">
									<div class="modal-content">
									  ...
									  <div class="modal-body">
									    ...
									    <input id="assignment_id" name="assignment_id"  runat="server" type="hidden" />
									    </form>
									  </div>
									  <div class="modal-footer" align="center">
									  <span id = span></span>
									   <a id="href" href="" style="color: white"  >下架此任务</a>
									  </div>
									</div>
								</div>   
            </div>
